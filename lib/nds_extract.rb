...
def movies_with_director_key(name, movies_collection)
  ...
  while i < movies_collection.length do 
    new_array.push (movie_with_director_name(name, movies_collection[i]))
    i+=1
  end
new_array
end
  ...
  while i < collection.length do 
    studio_name = collection[i][:studio]
     ...
     if !studio_gross[collection[i][:studio]]
       ...
       # if a studio isn't in there yet, studio_name=>total_gross
        else
      studio_gross[collection[i][:studio]] += collection[i][:worldwide_gross]
    end
    i += 1
...
def movies_with_directors_set(source)
  ...
  while i < source.length do
     ...
     a_o_a_movies_with_director_names << movies_with_director_key(name_key, movie)
     i += 1   
  end
  a_o_a_movies_with_director_names 
end
